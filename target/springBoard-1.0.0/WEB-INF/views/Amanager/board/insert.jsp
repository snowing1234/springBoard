 ...
 <div class="container">
  ...
  <div class="container" >
    <form class="needs-validation .was-validated" method="post" action="javascript:insertBoard()" name="form" id="board" novalidate>
      ...
      <div class="form-row">
        <div class="col" >
          <label for="id">게시판 이름 (영어)</label> 
          <input class="form-control" type="text" id="id" name="id" onkeyup='KeyUpForId()' placeholder="ex) default" required> 

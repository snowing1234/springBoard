...
<div class="container" style="max-width = 780px;">
  ...
  <form class="form-update" method="post" action="update.do">
	  ...
	  <div class="row">
	     <div class="col-sm-4">
	     <label for="changePW">변경할 비밀번호</label></div>
	     <div class="col-sm-8"><input type="password" id="changePW" name="pw" class="form-control" placeholder="" required autofocus></div>
	  </div>
	  <div class="row">
  	  <button class="btn btn-lg btn-primary btn-block" type="button" onclick="updatePW()">확인</button>
	  </div>
  </form>
</div>
